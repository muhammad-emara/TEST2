...
class Log {
			...
			public function __construct() {
				date_default_timezone_set('Asia/Dubai');	//Asia/Dubai
		    ...
		    */	
			 ...
			 */
				...
				file_put_contents($log, $logcontent);
                            ...
                            public function logActions($userName,$actionType,$Action,$pageName)
                            {
                                
                                
                                $message="User: ".$userName.' |-| actionType: '.$actionType.' |-| ActionDetail: '.$Action.' |-| Called From: '.$pageName.' |-| IP: '.$_SERVER['REMOTE_ADDR'].' |-| @'.microtime(true);
                                $date = new DateTime();
				$log = $this->path . $date->format('Y-m-d')."_userlogs.txt";
